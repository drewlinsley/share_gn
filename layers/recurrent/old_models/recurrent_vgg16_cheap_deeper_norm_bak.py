...
class Vgg16(GN, CreateGNParams, GNRnOps, GNFFOps):
    ...
    def __call__(self, rgb, constructor=None):
        ...
        X_shape = self.conv2_1.get_shape().as_list()
    ...
    def build(self, i0):
        ...
        fgru_2_td = self.image_resize(
            self.fgru_3,
            self.fgru_2.get_shape().as_list()[1:3], align_corners=True)
        with tf.variable_scope('fgru'):
    ...
    def conv_layer(self, bottom, name, learned=False, shape=False, use_relu=False):
