...
class Vgg16(GN, CreateGNParams, GNRnOps, GNFFOps):
    def __init__(
            ...
            horizontal_kernel_initializer=tf_fun.Identity(),  # .initializers.orthogonal(),
    ...
    def build(self, i0):
        ...
        #         1,
        #         1,
        #         self.pool2.get_shape().as_list()[-1],
        #         self.pool2.get_shape().as_list()[-1]])
        ...
        #         1,
        #         1,
        #         self.pool3.get_shape().as_list()[-1],
        #         self.pool3.get_shape().as_list()[-1]])
